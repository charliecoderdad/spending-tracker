...
/**
 * Added by Charlie to sort the month column!
 */
sortTable.month = function(Cell) {
	var months = [ 'January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December' ]
	var today = new Date();
	var myMonthDate = new Date(today.getFullYear(), months.indexOf(Cell.innerHTML)+1, 1, 0, 0, 0, 0);
	return myMonthDate.getTime() || 0;
};
